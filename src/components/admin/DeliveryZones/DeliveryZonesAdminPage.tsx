...
export default function DeliveryZonesAdminPage() {
  ...
  const getWindowsCount = (windows: Record<string, { start: string; end: string }[]>) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                <span className="text-blue-600">Admin</span> Delivery Zones
              </h1>
              <p className="mt-2 text-gray-600">Manage delivery areas and time windows</p>
            </div>
            <button
              onClick={handleAdd}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-8 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Delivery Zone Map</h2>
